<?php
    ...
    if (isset($_GET['id'])){
        $ID = $_GET['id'];
        $query = $conn->query("SELECT * FROM tbdivisi WHERE id = '".$ID ."'");
...
<div class="container-fluid">
                              ...
                              <div class="row clearfix">
                                ...
                                <div class="row clearfix">
                                    <div class="col-lg-offset-2 col-md-offset-2 col-sm-offset-4 col-xs-offset-5">
                                        <a href="index.php?agen=admin&view=queue"><button type="button" class="btn btn-primary m-t-15 waves-effect" name="batal">BATAL</button></a>
            ...
            if (isset($_POST['edit'])){
                ...
                $rubahdata = $conn->query("UPDATE tbdivisi SET name = '".$name."', komentar = '".$comment."', valid = '".$sah."', tglupdate = NOW() WHERE id = '".$_GET['id']."'");

                if ($rubahdata){
                    echo "<script>alert('Data Antrian/ Divisi Berhasil di Edit!');window.location.href='index.php?agen=admin&view=queue';</script>";
                }else{
                    echo "<script>alert('Data Antrian/ Divisi Gagal di Edit!');</script>";
                }
            }
        }
        ?>
